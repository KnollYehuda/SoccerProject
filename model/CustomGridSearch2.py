...
csv_list_random_forest = [[n_estimators_RF, criterion, bootstrap, warm_start, 'n_games', 'acc']]
...
objective_lgbm_list = ['lambdarank']
...
depth_cat_boost_list = [4]

boosting_type_cat_boost = 'boosting_type'
boosting_type_cat_boost_list = ['Ordered']
...
data_predict_org = Data_Predict_Organizer()
                                #<leaugeName>/<model>/sp_model_<accurate>.joblib
joblib_save_path = 'JobLibModels2/{}/{}/sp_model_{}.joblib'
                                      #<leauge>/<modelName>/test_result.csv
csv_test_result_path = 'csvTestResult2/{}/{}/test_result.csv'
        ...
        for l_rate in parameters_LGBM[learning_rate]:
            for n_est in parameters_LGBM[n_estimators]:
                for obj in parameters_LGBM[objective_lgbm]:
                    ...
                    #model = XGBClassifier() # TODO: REMOVE ME
...
write_result_to_csv(csv_test_result_path.format(england_leg, 'XGBClassifier'), results_xgb_england, best_model_string_xgb_england, csv_list_XGB)
...
# write_result_to_csv(csv_test_result_path.format(england_leg, 'KNeighborsClassifier'), results_knn_england, best_model_string_knn_england, csv_list_KNN)
...
# write_result_to_csv(csv_test_result_path.format(england_leg, 'RandomForestClassifier'), results_rf_england, best_model_string_rf_england, csv_list_random_forest)
...
#write_result_to_csv(csv_test_result_path.format(england_leg, 'LGBMClassifier'), results_lgbm_england, best_model_string_lgbm_england, csv_list_LGBM)
...
# write_result_to_csv(csv_test_result_path.format(england_leg, 'CatBoostClassifier'), results_cat_boost_england, best_model_string_cat_boost_england, csv_list_cat_boost)
...
# write_result_to_csv(csv_test_result_path.format(spain_leg, 'XGBClassifier'), results_xgb_spain, best_model_string_xgb_spain, csv_list_XGB)
...
# write_result_to_csv(csv_test_result_path.format(spain_leg, 'KNeighborsClassifier'), results_knn_spain, best_model_string_knn_spain, csv_list_KNN)
...
# write_result_to_csv(csv_test_result_path.format(spain_leg, 'RandomForestClassifier'), results_rf_spain, best_model_string_rf_spain, csv_list_random_forest)
...
# write_result_to_csv(csv_test_result_path.format(spain_leg, 'LGBMClassifier'), results_lgbm_spain, best_model_string_lgbm_spain, csv_list_LGBM)
...
# write_result_to_csv(csv_test_result_path.format(spain_leg, 'CatBoostClassifier'), results_cat_boost_spain, best_model_string_cat_boost_spain, csv_list_cat_boost)
...
# write_result_to_csv(csv_test_result_path.format(italy_leg, 'XGBClassifier'), results_xgb_italy, best_model_string_xgb_italy, csv_list_XGB)
...
# write_result_to_csv(csv_test_result_path.format(italy_leg, 'KNeighborsClassifier'), results_knn_italy, best_model_string_knn_italy, csv_list_KNN)
...
# write_result_to_csv(csv_test_result_path.format(italy_leg, 'RandomForestClassifier'), results_rf_italy, best_model_string_rf_italy, csv_list_random_forest)
...
# write_result_to_csv(csv_test_result_path.format(italy_leg, 'LGBMClassifier'), results_lgbm_italy, best_model_string_lgbm_italy, csv_list_LGBM)
...
# write_result_to_csv(csv_test_result_path.format(italy_leg, 'CatBoostClassifier'), results_cat_boost_italy, best_model_string_cat_boost_italy, csv_list_cat_boost)
...
#
# print('################### start germany XGBClassifier ###################')
# results_xgb_germany, best_model_string_xgb_germany = search_XGBClassifier(germany_leg, germany_test_data)
# write_result_to_csv(csv_test_result_path.format(germany_leg, 'XGBClassifier'), results_xgb_germany, best_model_string_xgb_germany, csv_list_XGB)
# print('################### finish germany XGBClassifier ###################')
#
# print('################### start germany KNeighborsClassifier ###################')
# results_knn_germany, best_model_string_knn_germany = search_KNN(germany_leg, germany_test_data)
# write_result_to_csv(csv_test_result_path.format(germany_leg, 'KNeighborsClassifier'), results_knn_germany, best_model_string_knn_germany, csv_list_KNN)
# print('################### finish germany KNeighborsClassifier ###################')
#
# print('################### start germany RandomForestClassifier ###################')
# results_rf_germany, best_model_string_rf_germany = search_RF(germany_leg, germany_test_data)
# write_result_to_csv(csv_test_result_path.format(germany_leg, 'RandomForestClassifier'), results_rf_germany, best_model_string_rf_germany, csv_list_random_forest)
# print('################### finish germany RandomForestClassifier ###################')
#
# print('################### start germany LGBMClassifier ###################')
# results_lgbm_germany, best_model_string_lgbm_germany = search_lgbm(germany_leg, germany_test_data)
# write_result_to_csv(csv_test_result_path.format(germany_leg, 'LGBMClassifier'), results_lgbm_germany, best_model_string_lgbm_germany, csv_list_LGBM)
# print('################### finish germany LGBMClassifier ###################')
#
...
# write_result_to_csv(csv_test_result_path.format(germany_leg, 'CatBoostClassifier'), results_cat_boost_germany, best_model_string_cat_boost_germany, csv_list_cat_boost)
